...
%   aff_files: [1-by-n cell array]
    ...
    for i = 1:length(hr_files)
        ...
        Data.HR.PP{i}(:,3) = bandpass(Data.HR.PP{i}(:,3), 300, 1300, false);
    end
    
    %colored_lineplot(Data.HR.PP{2}(:,3),Data.HR.PP{2}(:,4))
...
%     end
    ...
    [Data.HR.RegPP, Data.HR.PPhat] = gen_regression(big(:,[3:end-1]),big(:,end), 'log');
